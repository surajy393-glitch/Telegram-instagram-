...
**Need more help?**
Visit: https://dating-app-dev-5.preview.emergentagent.com
        """
    ...
    async def auth_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if existing_user:
            await update.message.reply_text(
                ...
                f"Visit your profile: https://dating-app-dev-5.preview.emergentagent.com"
            )
            return
        ...
        auth_url = f"https://dating-app-dev-5.preview.emergentagent.com/auth/telegram?token={auth_token}"
...
3. Start using LuvHive!
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if existing_user:
            ...
            response += "🌐 https://dating-app-dev-5.preview.emergentagent.com"
        else:
            response = "👋 Hi! You're not registered yet.\n\n"
            response += "Use /auth to link your Telegram account with LuvHive!\n\n"
            response += "Or visit: https://dating-app-dev-5.preview.emergentagent.com"
    ...
    async def run(self):
        ...
        logger.info(f"🌐 Web app: https://dating-app-dev-5.preview.emergentagent.com")
