...
**Need more help?**
Visit: https://chatfix-luvhive.preview.emergentagent.com
        """
    ...
    async def auth_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if existing_user:
            await update.message.reply_text(
                ...
                f"Visit your profile: https://chatfix-luvhive.preview.emergentagent.com"
            )
            return
        ...
        auth_url = f"https://chatfix-luvhive.preview.emergentagent.com/auth/telegram?token={auth_token}"
...
3. Start using LuvHive!
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if existing_user:
            ...
            response += "🌐 https://chatfix-luvhive.preview.emergentagent.com"
        else:
            response = "👋 Hi! You're not registered yet.\n\n"
            response += "Use /auth to link your Telegram account with LuvHive!\n\n"
            response += "Or visit: https://chatfix-luvhive.preview.emergentagent.com"
    ...
    async def run(self):
        ...
        logger.info(f"🌐 Web app: https://chatfix-luvhive.preview.emergentagent.com")
