...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://whereby-chat.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://whereby-chat.preview.emergentagent.com`
...
🌐 **Live URL:** https://whereby-chat.preview.emergentagent.com
