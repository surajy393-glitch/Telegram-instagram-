...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://luvhive-login-fix.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://luvhive-login-fix.preview.emergentagent.com`
...
🌐 **Live URL:** https://luvhive-login-fix.preview.emergentagent.com
